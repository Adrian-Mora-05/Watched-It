...
export default function AppLayout() {
  ...
  return (
      ...
      <Tabs screenOptions={{tabBarActiveTintColor:"white",tabBarInactiveTintColor:"#231709",tabBarStyle:{backgroundColor:"#5D3E14"}}}>
        ...
        <Tabs.Screen name="movie/review/[id]" options={{ headerShown: false, tabBarShowLabel: false, tabBarLabel: "Reseñas", title: "Ver reseña",href:null }} />
         <Tabs.Screen name="show/review/[id]" options={{ headerShown: false, tabBarShowLabel: false, tabBarLabel: "Reseñas", title: "Ver reseña",href:null }} />
      </Tabs>
